...
class Core extends Initiable
{
	...
	public function __construct(
		...
		Runnable $deactivator = null,
		Runnable $upgrader = null
	) {
		$this->plugin($plugin);
	...
	public static function create(
		...
		$plugin = (new Plugin(
			...
			->abspath($options['plugin_file'])
			->url($options['plugin_file'])
			->basename($options['plugin_file'])
			->name($name)
			->version($options['plugin_version'])
			->notices($name.'_notices');
