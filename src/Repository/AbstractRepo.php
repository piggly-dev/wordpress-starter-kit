...
namespace Piggly\Wordpress\Repository;

use Exception;
use Piggly\Wordpress\Connector;
use Piggly\Wordpress\Database\AbstractTableSchema;
use Piggly\Wordpress\Interfaces\RecordableModelInterface;
use wpdb;
...
abstract class AbstractRepo
{
	...
	{
		$data = \json_decode(\wp_json_encode($model->toRecord()), true);
