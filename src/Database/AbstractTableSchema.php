...
namespace Piggly\Wordpress\Database;
...
abstract class AbstractTableSchema
{
	 ...
	 * @return string
	 */
	abstract public static function createTable(): string;
	 ...
	 * @return string
	 */
	abstract public static function versionOptionKey(): string;
