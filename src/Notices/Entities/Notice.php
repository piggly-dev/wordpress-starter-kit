<?php
namespace Piggly\Wordpress\Notices\Entities;
...
class Notice
{
	...
	{ $this->_type = esc_attr($type); return $this; }
	...
	{ $this->_body = wp_kses_post($body); return $this; }
	...
	{ $this->_isDismissible = $isDismissible; return $this; }
	...
	{ $this->_id = esc_attr($id); return $this; }
	...
	{ $this->_showWhen = $condition; return $this; }
	...
	{ $this->_removeAfterSeen = $removeAfterSeen; return $this; }
	...
	{ return $this->_removeAfterSeen === true; }
}